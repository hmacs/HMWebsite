...
<div class="cp_customizer-editor-overlay">
    <div class="middle-align">
        ...
        <div style="padding-top: 1em;">
            <button onclick="cp_open_page_in_default_editor(event,'<?php echo $post->ID; ?>')" class="button button-link"><?php _e('Edit In Default Editor', 'mesmerize-companion') ?></button>
        </div>
    </div>
</div>
