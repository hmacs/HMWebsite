...
class WC_Admin_Notes_Add_First_Product {
	...
	public static function possibly_add_first_product_note() {
		...
		$content = __( 'Grow your revenue by adding products to your store. Add products manually, import from a sheet, or migrate from another platform.', 'woocommerce' );
		...
		$note->add_action( 'add-a-product', __( 'Add a product', 'woocommerce' ), admin_url( 'post-new.php?post_type=product' ), WC_Admin_Note::E_WC_ADMIN_NOTE_ACTIONED, true );
