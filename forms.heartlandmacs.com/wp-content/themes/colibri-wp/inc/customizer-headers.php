<?php return array (
  ...
  array (
    ...
    array (
      ...
      'header_front_page.hero.style.background.video.externalUrl' => 'https://www.youtube.com/watch?v=coYirc_qoSA',
      'header_front_page.hero.style.background.video.internalUrl' => '',
      'header_front_page.hero.style.background.video.poster.url' => '',
  ...
  array (
    ...
    array (
      ...
      'header_front_page.hero.style.background.image.0.source.url' => '%s/images/StockSnap_Z2FVSJZAEN-hero1-1024x576.jpg',
      'header_front_page.hero.style.background.image.0.position' => 'center center',
      'header_front_page.hero.style.background.image.0.attachment' => 'scroll',
      'header_front_page.hero.style.background.image.0.repeat' => 'no-repeat',
      'header_front_page.hero.style.background.image.0.size' => 'cover',
      ...
      'header_front_page.hero.style.background.slideshow.slides' => '%5B%7B%22url%22%3A%22%25s%5C%2Fimages%5C%2FStockSnap_Z2FVSJZAEN-hero1-1024x576.jpg%22%2C%22index%22%3A0%7D%2C%7B%22url%22%3A%22%25s%5C%2Fimages%5C%2Fslide-3-sea-body-of-water-beach-sky-blue-ocean-1589419-pxhere.com_.jpg%22%2C%22index%22%3A1%7D%2C%7B%22url%22%3A%22%25s%5C%2Fimages%5C%2Fslide-4-beach-sea-coast-sand-ocean-horizon-1266150-pxhere.com_.jpg%22%2C%22index%22%3A2%7D%5D',
      'header_front_page.hero.style.background.slideshow.duration.value' => '1500',
      'header_front_page.hero.style.background.slideshow.speed.value' => '500',
      'header_front_page.hero.style.background.video.videoType' => 'external',
      'header_front_page.hero.style.background.video.externalUrl' => 'https://www.youtube.com/watch?v=coYirc_qoSA',
  ...
  array (
    ...
    array (
      ...
      'header_front_page.hero.style.background.image.0.source.url' => '%s/images/images-xheader-default-0-1545411152082.jpg',
      'header_front_page.hero.style.background.image.0.position' => 'center center',
      'header_front_page.hero.style.background.image.0.attachment' => 'scroll',
      'header_front_page.hero.style.background.image.0.repeat' => 'no-repeat',
      'header_front_page.hero.style.background.image.0.size' => 'cover',
  ...
  array (
    ...
    array (
      ...
      'header_front_page.hero.style.background.color' => '#03a9f4',
      'header_front_page.hero.style.background.type' => 'slideshow',
      'header_front_page.hero.style.background.image.0.source.url' => '%s/images/guy-0-1561967557758.jpg',
      'header_front_page.hero.style.background.image.0.position' => 'center center',
      'header_front_page.hero.style.background.image.0.attachment' => 'scroll',
      'header_front_page.hero.style.background.image.0.repeat' => 'no-repeat',
      'header_front_page.hero.style.background.image.0.size' => 'cover',
