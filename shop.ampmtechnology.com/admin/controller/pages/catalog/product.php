        ...
        if (isset($this->request->get['product_id']) && $this->_validateCopy()) {
            ...
            if ($this->data['new_product']) {
                $this->session->data['success'] =
                    sprintf($this->language->get('text_success_copy'), $this->data['new_product']['name']);
    ...
    private function _getForm($args = array())
    {
        ...
        if (isset($this->request->post['product_description'])) {
            ...
            $this->data['product_description'] =
                $this->model_catalog_product->getProductDescriptions($product_id, $content_language_id);
        } else {
        ...
        $this->data['generate_seo_url'] =
            $this->html->getSecureURL('common/common/getseokeyword', '&object_key_name=product_id&id='.$product_id);
        ...
        $this->data['clone_url'] =
            $this->html->getSecureURL('catalog/product/copy', '&product_id='.$this->request->get['product_id']);
