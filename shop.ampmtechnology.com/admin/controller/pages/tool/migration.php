...
class ControllerPagesToolMigration extends AController
{
    ...
    public function step_one()
    {
        ...
        $this->data['form']['cart_type'] = $form->getFieldHtml(array(
            'type'     => 'selectbox',
            'name'     => 'cart_type',
            'required' => true,
            'options'  => $cart_types,
        ...
        $this->data['form']['cart_url'] = $form->getFieldHtml(array(
            'type'     => 'input',
            'name'     => 'cart_url',
            'required' => true,
        ...
        $this->data['form']['db_host'] = $form->getFieldHtml(array(
            'type'     => 'input',
            'name'     => 'db_host',
            'required' => true,
        ...
        $this->data['form']['db_user'] = $form->getFieldHtml(array(
            'type'     => 'input',
            'name'     => 'db_user',
            'required' => true,
        ...
        $this->data['form']['db_password'] = $form->getFieldHtml(array(
            'type'  => 'input',
            'name'  => 'db_password',
            'value' => $this->data['db_password'],
            'style' => 'large-field',
        ));
        $this->data['form']['db_name'] = $form->getFieldHtml(array(
            'type'     => 'input',
            'name'     => 'db_name',
            'required' => true,
        ...
        $this->data['form']['db_prefix'] = $form->getFieldHtml(array(
            'type'  => 'input',
            'name'  => 'db_prefix',
